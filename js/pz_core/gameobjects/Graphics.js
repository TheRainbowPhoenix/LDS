...
Phaser.Graphics = function (game, x, y)
{
    ...
    this._baseInstance = new PIXI.Container();
    Object.assign(this, this._baseInstance);
    // Proxy/expose private methods ...
     ...
     */
    this.blendMode = Graphics.BLEND_NORMAL; // PIXI.blendModes.NORMAL;
