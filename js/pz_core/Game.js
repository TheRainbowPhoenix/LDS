...
Phaser.Game = function (width, height, renderer, parent, state, transparent, antialias, physicsConfig)
{
     ...
     * @default
     */
    this.width = width || Graphics.width || 800;
     ...
     * @default
     */
    this.height = height || Graphics.height || 600;
     ...
     * @protected
     */
    this.renderer = Graphics._renderer; // Use RMMV/Pixi7 Renderer
     ...
     * @default
     */
    this.lockRender = false; // TODO: RMMV handles rendering
...
Phaser.Game.prototype = {
    ...
    boot: function ()
    {
        ...
        // Link to RMMV Scene Logic if desired, 
        // otherwise Phaser World is just a container we render manually or attach
        ...
        // Bridge Sound to Html5Audio/WebAudio from RMMV or use Phaser's
    ...
    {
        // if (this.pendingDestroy || !this.isBooted) return;
