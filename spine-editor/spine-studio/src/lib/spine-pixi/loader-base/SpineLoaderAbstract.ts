import { type ISkeletonData, type ISkeletonParser, TextureAtlas } from '../base';
import { type AssetExtension, checkExtension, type Loader, LoaderParserPriority } from '@pixi/assets';
