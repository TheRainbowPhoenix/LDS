...
Phaser.SoundManager.prototype = {
    ...
    pauseAll: function ()
    {
        ...
        // RMMV doesn't have a direct 'pause all SE' exposed easily without iterating buffers,
        // but typically simply muting or stopping BGM is expected.
        // For bridge simplicity, we might just stop BGM/BGS.
    ...
    resumeAll: function ()
    {
        ...
        AudioManager.replayBgs(AudioManager.saveBgs());
    },
...
Object.defineProperty(Phaser.SoundManager.prototype, 'mute', {
    ...
    set: function (value)
    {
        if (value)
        {
            ...
            this._storedVolume = AudioManager.masterVolume || 1;
        ...
        else
        {
            ...
            AudioManager.masterVolume = this._storedVolume || 1;
        }
    }
