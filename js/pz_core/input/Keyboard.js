...
Phaser.Keyboard.prototype = {
    ...
    start: function ()
    {
        ...
        /*
        TODO: we rely on RPG Maker events
    ...
    {
        if (Input.isRawPressed) {
            return Input.isRawPressed(keycode);
        }
        // Fallback for standard RMMV mappings if patch not applied
        return this._mapRMMVKey(keycode);
        /*
        if (this._keys[keycode])
        {
    ...
    /**
     * Helper to map Phaser keycodes to RMMV string aliases
     * Only used if the `Input.isRawPressed` patch isn't applied.
     */
    _mapRMMVKey: function(keycode) {
        // TODO: Basic mapping for common usage
        switch(keycode) {
            case Phaser.Keyboard.SPACE: return Input.isPressed('ok');
            case Phaser.Keyboard.ENTER: return Input.isPressed('ok');
            case Phaser.Keyboard.ESC:   return Input.isPressed('cancel');
            case Phaser.Keyboard.UP:    return Input.isPressed('up');
            case Phaser.Keyboard.DOWN:  return Input.isPressed('down');
            case Phaser.Keyboard.LEFT:  return Input.isPressed('left');
            case Phaser.Keyboard.RIGHT: return Input.isPressed('right');
